#!/usr/bin/env python3
"""
Normalize or remove entries with single-letter surnames (C, D, I, S).
...
async def normalize_single_letter_surnames():
    ...
    try:
        ...
        print('🔍 Finding entries with single-letter surnames...')
        all_bad = []
        ...
        print(f'\n📊 Found {len(all_bad)} entries with single-letter surnames')
...
if __name__ == "__main__":
    asyncio.run(normalize_single_letter_surnames())
