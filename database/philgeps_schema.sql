...
\restrict 3fSJlrUvLayhkkEWFh5ds9HNhGrD4tJVGSPlxb978CHHHbXco0jHG0ZuXsl6cZp
...
CREATE TABLE public.contractors (
    ...
    source text DEFAULT 'project_contractors'::text,
...
--
-- Name: contracts; Type: TABLE; Schema: public; Owner: budget_admin
--
...
CREATE TABLE public.contracts (
    ...
    area_of_delivery character varying(255),
    business_category character varying(255),
    contract_amount numeric(15,2),
    award_date timestamp without time zone,
    award_status character varying(50),
    meilisearch_id text
);


ALTER TABLE public.contracts OWNER TO budget_admin;

--
-- Name: contracts_id_seq; Type: SEQUENCE; Schema: public; Owner: budget_admin
--
...
ALTER TABLE public.contracts_id_seq OWNER TO budget_admin;

--
-- Name: contracts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: budget_admin
--
...
--
-- Name: contracts id; Type: DEFAULT; Schema: public; Owner: budget_admin
--
...
--
-- Name: contractors contractors_contractor_name_key; Type: CONSTRAINT; Schema: public; Owner: budget_admin
--
...
--
-- Name: contracts contracts_pkey; Type: CONSTRAINT; Schema: public; Owner: budget_admin
--
...
--
-- Name: idx_contracts_meilisearch_id; Type: INDEX; Schema: public; Owner: budget_admin
--

CREATE INDEX idx_contracts_meilisearch_id ON public.contracts USING btree (meilisearch_id);
...
\unrestrict 3fSJlrUvLayhkkEWFh5ds9HNhGrD4tJVGSPlxb978CHHHbXco0jHG0ZuXsl6cZp
